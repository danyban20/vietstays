...
$pg_title   = 'Users';
vv_show_page_title_bar(['pg_title' => $pg_title, 'add_link' => vv_admin_url('users/add'), 'add_txt' => 'Add New User']);
$meta_title = vv_admin_meta_title( $pg_title );


$filter = ['per_page' => 30, 'pgnum' => 1, 'return_total' => 1, 'vv_user_level' => 'customer'];
