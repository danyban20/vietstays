    ...
    <div class="col-md-4">
        <?php if($logged_user_role == 'administrator'){ ?>
            <div class="text-right mb-3">
                <a href="<?php echo vv_admin_url('locations/districts/add') ?>" class="btn btn-sm btn-primary"><?php vv_e( 'Add District' ); ?></a>
            </div>
        <?php } ?>
    </div>
</div>
                    ...
                    foreach($districts as $district){
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo vv_admin_url('locations/neighbourhoods').'?district_id='.$district_id ?> "><?php echo count($neighbourhoods) ?></a>
                            </td>
                            <td class="text-right p-2">
                                <a href="<?php echo vv_admin_url('locations/districts/edit').'?id='.$district['ID'] ?>" target="_blank" title="<?php echo esc_attr( vv__( 'Edit' ) ); ?>"><i class="fa fa-pencil-alt"></i></a>
                            </td>
                        </tr>
                        <?php 
                    }
