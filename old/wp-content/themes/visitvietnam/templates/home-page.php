                ...
                <div class="cap">
                  ...
                  <div class="book_block">
                      <div class="input_wrap choose_city_sel">
                          <label>Where</label>
                          <a href="#" class="room_btn">Choose city</a>
                          <div class="city_dropdown book_dropdown">
                          	  <ul>
                              	  <li><a href="#"><strong>Ho Chi Minh City</strong></a></li>
                                  <li><a href="#"><strong>Da Nang</strong></a></li>
                                  <li><a href="#"><strong>Nha Trang</strong></a></li>
                              </ul>
                          </div>
                      </div>
